...
- Exploratory ERP analysis using MNE (MNE sample dataset).
- Single-trial amplitude extraction and a compact Bayesian two-group model to infer ERP amplitude differences.
